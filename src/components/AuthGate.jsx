    ...
    <div className="auth-screen">
      <div className="auth-card">
        ...
        <div className="auth-partners">
          <span className="chip balaji">Balaji</span>
          <span className="chip nagoor">Nagoor</span>
          <span className="chip jp">JP</span>
          <span className="chip gray" style={{ marginLeft: 6 }}>Only</span>
        </div>
        ...
        <div className="auth-footer">
          🔒 Only 3 co-founders access. Access denied for everyone else.
        </div>
      </div>
    </div>
  );
